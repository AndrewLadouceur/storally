	...
	if (isset($_POST))
	{
		...
		if ($o->count >= 1)
		{
			...
			$data = Array(
				...
				'password'=>$o->escape(stripslashes(md5($_POST['pass']))),
				'ip'=>$_SERVER['REMOTE_ADDR'],
				'first_name'=>$o->escape(stripslashes($_POST['fname'])),
				'last_name'=>$o->escape(stripslashes($_POST['lname'])),
				'address'=>$o->escape(stripslashes($_POST['address'])),
				'postal_code'=>$o->escape(stripslashes($_POST['pcode'])),
				'phone'=>$o->escape(stripslashes($_POST['phone'])),
				'ally'=>escape(stripslashes($_POST['storeeValue'])),
				'regtime'=>time()
			);
